...
% =====================================================================
\section{Verdict matériel : le 780M ne peut pas entraîner --- où alors ?}
...
de petite taille), soit \textbf{déporté} sur une machine tierce
(§\ref{sec:destinations}). Cela n'invalide pas le projet : les voies les plus
rentables (§\ref{sec:voies}, A, B et D) s'entraînent ou s'exécutent en CPU.}
